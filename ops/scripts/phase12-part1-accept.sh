...
marker="${acceptance_dir}/PHASE12_PART1_ACCEPTED.md"

run_step() {
  local label="$1"
  shift
  echo "[phase12.part1] ${label}"
  "$@"
}
...
run_step "Phase 12 Part 1 entry check" make -C "${FABRIC_REPO_ROOT}" phase12.part1.entry.check
