...
marker="${acceptance_dir}/PHASE11_PART1_ACCEPTED.md"

run_step() {
  local label="$1"
  shift
  echo "[phase11.part1] ${label}"
  "$@"
}
...
run_step "Phase 11 Part 1 entry check" make -C "${FABRIC_REPO_ROOT}" phase11.part1.entry.check
