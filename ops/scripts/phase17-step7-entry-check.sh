...
out_file="${FABRIC_REPO_ROOT}/acceptance/PHASE17_STEP7_ENTRY_CHECKLIST.md"
...
files=(
  ...
  "ops/ai/mcp/start.sh"
  "ops/ai/mcp/stop.sh"
  "ops/ai/mcp/doctor.sh"
  "ops/ai/mcp/test/run.sh"
  "ops/ai/mcp/test/test-repo.sh"
  "ops/ai/mcp/test/test-evidence.sh"
  "ops/ai/mcp/test/test-observability.sh"
  "ops/ai/mcp/test/test-runbooks.sh"
  "ops/ai/mcp/test/test-qdrant.sh"
  "ops/ai/mcp/deploy/README.md"
  "ops/ai/mcp/deploy/env.example"
  "ops/ai/mcp/deploy/systemd/mcp-repo.service"
  "ops/ai/mcp/deploy/systemd/mcp-evidence.service"
  "ops/ai/mcp/deploy/systemd/mcp-observability.service"
  "ops/ai/mcp/deploy/systemd/mcp-runbooks.service"
  "ops/ai/mcp/deploy/systemd/mcp-qdrant.service"
...
if rg -n "policy-ai-mcp.sh" "${FABRIC_REPO_ROOT}/ops/policy/policy.sh" >/dev/null 2>&1; then
  pass "MCP policy wired" "rg -n policy-ai-mcp.sh ops/policy/policy.sh"
else
  fail "MCP policy wired" "rg -n policy-ai-mcp.sh ops/policy/policy.sh" "missing policy wiring"
fi
...
make_targets=(
  ...
  "ai.mcp.start"
  "ai.mcp.stop"
  "phase17.step7.entry.check"
  "phase17.step7.accept"
)
