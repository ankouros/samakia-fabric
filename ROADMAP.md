...
- Vault-default secrets backend with file-backend exceptions (runtime defaults updated; no secret migrations).
...
- Step 4 (internal Postgres HA prerequisite + DNS alias + real canary exposure): **COMPLETED**
